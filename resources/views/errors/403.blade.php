        ...
        <div class="w-9/12 m-auto py-16 min-h-screen flex items-center justify-center">
            <div class="bg-white shadow overflow-hidden sm:rounded-lg pb-8">
                <div class="border-t border-gray-200 text-center pt-8">
                    ...
                    <a href="{{ route('index') }}"
                        class="bg-indigo-500 cursor-pointer hover:bg-indigo-700 text-white font-semibold px-6 py-3 rounded-md mr-6">
                        HOME
                    </a>
                    <a href="{{ URL::previous() }}"
                        class="bg-gradient-to-r cursor-pointer from-red-400 to-red-500 hover:from-red-500 hover:to-red-500 text-white font-semibold px-6 py-3 rounded-md">
                        GO BACK
                    </a>
                </div>
            </div>
