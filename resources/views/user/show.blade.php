                            ...
                            <div
                                ...
                                class="bg-black/50 px-3.5 h-10 flex items-center justify-center rounded-full text-white absolute right-3 top-3 "><svg
                                    ...
                                    <path
                                        ...
                                        stroke-linejoin="round"></path>
                                </svg><span class="ml-2 text-sm">22</span></button>
                        </div>
                        ...
                        <div class="">
                            <div class="pb-9 space-y-5">
                                <div class="flex justify-between items-center"><span
                                        class="nc-Badge inline-flex px-2.5 py-1 rounded-full font-medium text-xs text-green-800 bg-green-200  relative">Virtual
                                        Worlds</span>
                                    <div class="flow-root">
                                        <div class="flex text-neutral-700 text-sm -mx-3 -my-1.5">
                                            ...
                                            <div class="">
                                                <div class="relative inline-block text-left"><button
                                                        ...
                                                        title="More" id="headlessui-menu-button-:rk:" type="button"
                                                        aria-haspopup="true" aria-expanded="false"><svg
                                                            class="w-4 h-4 sm:h-5 sm:w-5" viewBox="0 0 24 24"
                                                            fill="none">
                                                            <path
                                ...
                                <div class="flex items-center">
                                    ...
                                    <a href="#"
                                        class="text-sm mx-1 font-medium text-gray-900 underline hover:no-underline">73
                                        reviews</a>
                                    ...
                                    <div class="flex items-center ">
                                        <div
                                            ...
                                            <img class="absolute inset-0 w-full h-full object-cover"
                                                ...
                                                alt="John Doe"><span class="wil-avatar__name">J</span>
                                        </div>
                                        <span class="ml-2.5 text-neutral-500 flex flex-col"><span
                                                class="text-sm">Company</span><span
                                                class="text-neutral-900 font-medium flex items-center"><span>Benu</span><span
                                                    class="ml-1"><svg class="w-4 h-4"
                            ...
                            <h2 class="text-indigo-500 font-bold text-2xl border-0">Price: €{{ $product->price }}</h2>
                            {{-- <div class="py-9">
                                <div class="space-y-5">
                            ...
                            <div class="p-0 border-0">
                                ...
                                <div class="mt-8 flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                                    <a
                                        class="btn inline-block cursor-pointer bg-indigo-500 text-md font-medium hover:bg-indigo-600 text-white p-3 rounded">
                                        Add to Cart
                                    </a>
                                </div>
