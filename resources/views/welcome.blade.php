<x-guest-layout>
            ...
            <div class="flex items-center mt-10 flex-wrap justify-around">
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="flex max-w-xs items-center mt-6 mb-6 ml-auto">
                        ...
                        <div class="text-gray-600 text-base font-normal">
                            <h3 class="leading-none text-gray-700 text-xl font-bold mb-2">Free Shipping</h3>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="flex max-w-xs items-center mt-6 mb-6 ml-auto">
                        ...
                        <div class="text-gray-600 text-base font-normal">
                            <h3 class="leading-none text-gray-700 text-xl font-bold mb-2">Hot Offers</h3>
    ...
    <section class="mb-7 p-4 mt-4">
        <div class="w-full">
            <div class="row flex flex-wrap justify-between">
                <div data-aos="fadeInUp" class="xl:w-1/4 p-4 lg:w-1/3 md:w-1/6 mb-sm-5 mb-md-0 mb-4 animate__faster">
                    <h4
                    ...
                    <div class="product-list-small animate__fast">
                        <article class="flex mb-5">
                            ...
                            <div class="md:w-8/12 mb-0  p-2">
                                <h6>
                                    <a class="text-gray-700 text-lg font-bold leading-3 hover:text-sky-700" href="#">Pasta</a>
                                </h6>
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 text-amber-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                                    <svg class="w-5 h-5 text-amber-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                                    <svg class="w-5 h-5 text-amber-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                                    <svg class="w-5 h-5 text-amber-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                                    <svg class="w-5 h-5 text-gray-300 dark:text-gray-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                                    <p class="ml-2 text-sm font-medium text-gray-500 dark:text-gray-400">(4.0)</p>
                                </div>
                                <div class="product-price text-sky-600 text-lg font-bold mt-3">
                                    <span>$32.85</span>
                                    <span class="text-base text-gray-400 mr-2 line-through">$33.8</span>
                                </div>
                            </div>
                        </article>
                        <article class="flex mb-5">
                ...
                <div data-aos="fadeInUp" class="xl:w-1/4 p-4  lg:w-1/3 md:w-1/6 mb-sm-5 mb-md-0 mb-4  d-none d-lg-block animate__faster">
                    <h4
                        class="relative text-2xl after:w-20 after:content-[''] after:h-1 after:absolute after:bottom-0 after:left-0 after:bg-sky-600 border-b text-gray-700 font-bold leading-5 border-gray-200 pb-5  mb-7">
                        Recently added</h4>
                    <div class="product-list-small">
    ...
    <footer data-aos="animate__fadeInUp" class="footer_section carparts_footer text-white clearfix  font-normal text-base">
        <div class="bg-gray-800 py-10" data-bg-color="#131313">
            <div class="w-full">
                <div class="flex justify-between flex-wrap mx-4">

                    <div class="flex lg:w-4/12 md:w-6/12 sm:w-6/12 w-full">
                        <div class="py-10">
                            <div class="brand_logo mb-10">
                                <a href="index.html">
                                    <img src="https://flowbite.com/docs/images/logo.svg" srcset="assets/images/logo/logo_02_2x.png 2x" alt="logo_not_found">
                                </a>
                            </div>
        ...
        <div class="footer_bottom clearfix" data-bg-color="#000000" style="background: rgb(0, 0, 0);">
            <div class="container">
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <p class="copyright_text mb-0">© <a href="#!" class="author_link text-white">Diploma</a> - All rights Reserved</p>
                    </div>

                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="payment_methods float-lg-right">
                            <img src="{{ asset('assets/payment-method.png') }}" alt="image_not_found">
                        </div>
                    </div>
                </div>
            </div>
